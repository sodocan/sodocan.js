...
exports.postSkeleton = function(req, res) {
  ...
  // var username = skeleton.username; // comment this back in and delete line below
  var username = skeleton.username || 'noUsername'; //just while parser auth is temporarily disabled
